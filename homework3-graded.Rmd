...
**JC Grading -3**
Hi Sarah, just a heads up that this was the 2015 assignment.  Fortunately, this assignment was similar to 2016 (though the data was slightly different).  This may not always be the case for other assignments.
...
**JC Grading -1**
Please print out/report result of power.
